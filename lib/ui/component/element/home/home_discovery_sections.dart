  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return discoveryAsync.when(
      loading: () => const SliverToBoxAdapter(
        child: AnimatedHomeSection(child: _HomeDiscoverySkeleton(key: ValueKey('home-discovery-loading'))),
      ),
      error: (error, stackTrace) => const SliverToBoxAdapter(
        child: AnimatedHomeSection(child: SizedBox.shrink(key: ValueKey('home-discovery-error'))),
      ),
      data: (data) {
        ...
        return SliverToBoxAdapter(
          child: AnimatedHomeSection(
            child: Padding(
              key: ValueKey('home-discovery-${hasHistory ? 'history' : 'suggested'}-${primaryTracks.length}'),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: const [
          ...
          SizedBox(height: 14),
          HomeSectionSkeletonBox(width: double.infinity, height: 390, borderRadius: 24),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(title, style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900, height: 1.0)),
          const SizedBox(height: 6),
          if (subtitle != null)
            Text(subtitle!, style: TextStyle(fontSize: 13, color: scheme.onSurfaceVariant.withAlpha(210))),
        ],
      ),
    );
  }
